  ...
  return (
    <>
      <div className="row justify-content-between calenderHeader">
        <h1 className="col-3 text-white fw-bold">{monthYear}</h1>
      ...
      <div className="weekDays">
        ...
        <div className="dayBox text-white fw-bold d-flex justify-content-center">
          Monday
        </div>
        <div className="dayBox text-white fw-bold d-flex justify-content-center">
          Tuesday
      ...
      <div className="dateBox row">
        ...
        {new Array(daysInMonth).fill().map((_, index) => (
          ...
          >
            ...
            <div><DateCard date={index + 1} month={month} year={year} /></div>
          </div>
        ))}
      </div>
    </>
